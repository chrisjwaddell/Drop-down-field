...
const fieldCountry = {
    init: function countryInsert(fieldname, placeholder) {
        // let listcreated = false
        // console.log(`init: listcreated - ${listcreated}`)
...
console.log(fieldCountry.insert)

fieldCountry.init('Country of birth', 'Country of birth')

fieldCountry.init('Country of residence', 'Country of residence')

// window.onload = function() {
//     window.setTimeout(() => document.querySelectorAll('.field input')[1].focus(), 0);
// }

const elCountries = document.querySelectorAll('input')
elCountries[1].focus()
