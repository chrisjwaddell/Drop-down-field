...
You have options over how filtering is done. This drop down field is a one
column list. And one selection only.
...
be visible to go through the list. <br><br><br>
...
Autocomplete kills the Escape fallback to original value feature. <br> <br> <br>
...
The CSS should be placed after dropdown-field.css in the CSS hierarchy. Some CSS
variables for drop down field styling are:
...
This drop down list is for a finite number of options. It's best to keep the
list no more than say 200 or 300.
